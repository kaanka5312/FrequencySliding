...
f_BDI <- bf(
  ...
  sigma ~ 0 + group,                # ??BP , ??HC  (log-link)
  nu    ~ 0 + group                 # ??BP , ??HC  (log-link, Student-t)
)
...
priors <- c(
  ...
  # BOTH log-?? coefficients (b_sigma_groupBP & b_sigma_groupHC)
  prior(normal(0, 0.30),               class = "b", dpar = "sigma"),
  
  # BOTH log-?? coefficients (b_nu_groupBP & b_nu_groupHC)
...
## ??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
## 3.  Model: group-specific ?? and ?? (Student-t residuals)
## ??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
f_BDI <- bf(
